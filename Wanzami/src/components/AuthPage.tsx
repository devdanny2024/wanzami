      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-purple-600 via-orange-600 to-teal-500">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-12 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <Logo size="splash" />
            <h1 className="text-white text-5xl font-semibold mt-6 mb-4">Welcome Back</h1>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              disabled={loading}
              className="w-full bg-[#fd7e14] hover:bg-[#e86f0f] text-white py-3 rounded-lg transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
            >
