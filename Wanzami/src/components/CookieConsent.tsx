...
export function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[10010]">
      <div className="w-full bg-[#f7e600] text-black px-4 py-6 md:px-10 md:py-8 shadow-2xl border-t border-black/10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 items-start">
          <div className="lg:col-span-2 space-y-3">
            <div className="text-lg md:text-xl font-semibold">This website uses cookies</div>
          ...
          <div className="flex flex-col gap-3 lg:items-end">
            <button
              className="w-full lg:w-48 h-12 rounded-full bg-black text-white text-sm font-semibold hover:opacity-90 transition"
