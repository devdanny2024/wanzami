...
export default function TitleClient({ id }: { id: string }) {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // No redirect here: logged-out visitors see a public teaser of the
      // title (poster, synopsis, buy/sign-up CTA) so shared movie links
      // actually land on the movie instead of bouncing to /splash.
    }
  }, [router]);
