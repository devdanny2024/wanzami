...
router.post("/admin/invitations", requireAuth, requireAdmin, requirePermission(Permission.ADMIN_INVITES_MANAGE), inviteAdmin);
router.get("/admin/invitations", requireAuth, requireAdmin, requirePermission(Permission.ADMIN_INVITES_MANAGE), listInvites);
router.delete("/admin/invitations/:id", requireAuth, requireAdmin, requirePermission(Permission.ADMIN_INVITES_MANAGE), revokeInvite);
router.post("/admin/invitations/accept", acceptInvite);
router.get("/admin/users", requireAuth, requireAdmin, requirePermission(Permission.ADMIN_USERS_MANAGE), listAdminUsers);
router.get("/admin/users/all", requireAuth, requireAdmin, requirePermission(Permission.ADMIN_USERS_MANAGE), listAllUsers);
router.patch("/admin/users/:id/role", requireAuth, requireAdmin, requirePermission(Permission.ADMIN_USERS_MANAGE), updateUserRole);
router.delete("/admin/users/:id", requireAuth, requireAdmin, requirePermission(Permission.ADMIN_USERS_MANAGE), deleteUser);
