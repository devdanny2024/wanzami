...
export function LoginScreen({ onLogin, onNavigateToRegister }: LoginScreenProps) {
  return (
    <div className="min-h-screen bg-[#0B0B0F] flex flex-col">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#FF6A00]/10 via-[#0B0B0F] to-[#0B0B0F]" />
      ...
      <div className="relative flex-1 flex flex-col justify-center px-6 py-12">
        ...
        >
          ...
          <p className="text-[#A1A1AA]">Sign in to continue watching</p>
        </motion.div>
        ...
        >
          <button className="text-[#FF6A00] text-sm mb-4 hover:underline">
            Forgot Password?
          </button>
